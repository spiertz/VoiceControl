...
\end{python}
beginnen.
Welche Ausgabe liefern die Python-Schnipsel, A oder B?\\\\
Bewertungsschema:\\
Keine Markierung an einem Python-Schnipsel führt zu $0$ Punkten.\\
Eine richtige Markierung der Ausgabe (A oder B) des jeweiligen Python-Schnipsels gibt $+1$ Punkt.\\
Eine falsche Markierung der Ausgabe (A oder B) des jeweiligen Python-Schnipsels gibt $-1$ Punkt.\\

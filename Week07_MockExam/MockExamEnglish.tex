...
import numpy as np
\end{python}
Determine for each snippet  if the ouput is A or B (by marking the correct output on the sheet). Each correct answer gives you $2$ partial points. The overall points are the sum of the partial points minus ten. If your overall points are negative, they are set to zero.
